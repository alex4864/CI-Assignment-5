...
\begin{document}
	...
	In 4 dimensions, the K-means algorithm misclassified considerably fewer samples.  We take this to mean that having more features to operate improves clustering accuracy.
