...
\begin{document}
	...
	\subsubsection{How much of the variance in the data is explained this way?}
        ...
        \subsubsection{How does the performance of your algorithms compare to scenario 2.1 and scenario 2.2?}
          ...
          The number of misclassified points was 2 with EM and 13 with K-means. It showed same behavior with scenario 1.
        ...
        to 2 so it took less time and showed more accuracy. The number of misclassified point was 3 in average.
        It is slightly less value compared to 4 in scenario 2. K-means also had shorter running time.
        The number of misclassified point was 9 in average.
